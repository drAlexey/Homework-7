...
console.log(getMiddleTaxes.call(ukraine)); 
          ...
          // ФУНКЦІЯ 3
//Рахує,скільки всього податків платять IT-спеціалісти у кожній країні. 
// Функція повинна викликатись через call та працювати з даними через this.
...
console.log(getTotalTaxes.call(ukraine)); 
          ...
          // ФУНКЦІЯ 4
//Буде писати в консоль об'єкт виду:{ salary: number, taxes: number, profit: number } кожні 10 секунд.
